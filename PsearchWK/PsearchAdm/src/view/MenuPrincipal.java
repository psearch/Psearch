...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		tcons = TableGradeCons.getTable(bd, "select p.nome_razsocial as Nome,p.email as email,p.cidade as cidade,p.estado as uf,c.descricao as profissao from pessoa p,categoria_prof c where p.ID_categoria=c.ID_categoria");
