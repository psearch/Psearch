			...
			$(xml)
					...
					.each(
							function() {
								...
								var contentString = '<div id="iw-container"><header id="divisoria"></header><header class="iw-title"><b >'+nme+" - "+pro+'</b></header><div  id="cont" id="content"><form  action="actionAvaliacao.jsp" method="get"> <table ></tr></td><tr><td  linhaspan="6"></tr></td>'
									
									
										+ '</td></tr><tr><td class="tabless"><b>Endereço:</b> '
										+ rua
										+ '</td></tr><tr><td class="tabless"><b>Email:</b>'+email
										+ '</tr></td>'
										+ '</td></tr><tr><td class="tabless"><b>Telefone:</b>'+tel
										+ '</tr></td>'
								...
								google.maps.event.addListener(infowindow, 'domready', function() {
									...
									// Referência ao DIV que agrupa o fundo da infowindow
									    ...
									    iw_btnClose.css({opacity: '1', right: '-12px', top: '-12px', border: '7px solid #D91E41', 'box-shadow': '0 0 5px #3990B9'});
...
<body  onload="loadXMLFile();scrool()">
	...
	<header id="panel">	
		...
		<input id="btloc"  class="button"  type="submit"
			value="Minha Localização" onclick="codeAddress();reload()"/>
