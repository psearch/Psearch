...
<body onload="loadXMLFile();">
	...
	<div id="tudo">
<header>
<input action="xmlcreate.jsp" placeholder="Rua,estado,cidade" id="address"
			class="inputs" type="text" /> <input id="btloc" class="button"
			type="submit" value="Minha Localização"
			onclick="codeAddress()" /> <input style="visibility: hidden"
	...
	<form id="formlocpro" action="xmlcreate_map.jsp" method="get">
		...
		<footer id="rodape"> <nav class="link"> <a
			href="index.html">Início</a> <a href="estatisticas.html">Estatísticas</a>
		<a href="sobre_nos.html">Sobre Nós</a> <a href="fale_conosco.html">Fale
			Conosco</a> 
