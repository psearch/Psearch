...
<header id="menu">
<a  class="buttons" href="inicio.html">Início</a> <a  class="buttons" href="ranking.html">Ranking</a> <a
				href="sobreNos.html"  class="buttons" >Sobre Nós</a> <a class="buttons"  href="faleConosco.html">Fale
				Conosco</a>
</header>
		...
		<article id="conteudo">
			...
			<form action="actionCadastrojsp.jsp">
				...
				Nome/Razão Social: <input class="textbox" name="nome" type="text" value=""
 ...
 País: <input class="textbox" type="text" id="pais" name="pais"
				...
				Numero: <input class="textbox" type="text" id="numero" name="num" size="30"
					...
					size="30" maxlength="50" /><br /> <select class="textbox"  action="cadastro.jsp"
					name="profissao">
