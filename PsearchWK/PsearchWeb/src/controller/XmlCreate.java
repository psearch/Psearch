...
public class XmlCreate {
	...
	public void gerarXmlUser(String caminho ,String endereco){
		Element oco = new Element("ocorrencia");
		Element end = new Element("endrss");
		
		
		Element logradouro = new Element("logradouro");
		
		Document documento = new Document(logradouro);
		
		
		
		end.setText(endereco);
		oco.addContent(end);
		logradouro.addContent(oco);
